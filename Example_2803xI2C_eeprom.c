...
//      if(I2cMsgOut1.MsgStatus == I2C_MSGSTAT_SEND_WITHSTOP)//0x0010
//      {
...
//      }  // end of write section
      ...
      // not inactive.
    //  if(1)//(I2cMsgOut1.MsgStatus == I2C_MSGSTAT_INACTIVE)
      {
...
Uint16 I2CA_ReadData(struct I2CMSG *msg)
{
   ...
   if(msg->MsgStatus == I2C_MSGSTAT_SEND_NOSTOP)
   {
      ...
      I2caRegs.I2CDXR = msg->MemoryHighAddr;
      I2caRegs.I2CDXR = msg->MemoryLowAddr;
      I2caRegs.I2CMDR.all = 0x2630;//0x2620;			// Send data to setup EEPROM address
   }
